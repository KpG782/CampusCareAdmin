...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color secondary = const Color(0xFF19C5C5);
  ...
  late Color background1 = const Color(0xFFF5F5F5);
  late Color background2 = const Color(0xFFFFFFFF);
  late Color shadow = const Color(0xFFB0B0B0);
  late Color text1 = const Color(0xFF1F1F1F);
  late Color text2 = const Color(0xFF19C5C5);
  late Color text3 = const Color(0xFF1F1F1F);
  late Color text4 = const Color(0xFFFFFFFF);
}
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color background1 = const Color(0xFF0D1B2A);
  late Color background2 = const Color(0xFF3A4A63);
  late Color shadow = const Color(0xFF2A3D56);
