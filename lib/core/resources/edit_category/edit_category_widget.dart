...
class EditCategoryWidget extends StatefulWidget {
  ...
  final DocumentReference? categoryList;
...
class _EditCategoryWidgetState extends State<EditCategoryWidget>
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      FFAppState().categoryImage = widget!.imageCategory!;
      safeSetState(() {});
    });
  ...
  Widget build(BuildContext context) {
    ...
    return BackdropFilter(
      ...
      child: Container(
        ...
        child: StreamBuilder<MentalResourcesRecord>(
          stream: MentalResourcesRecord.getDocument(widget!.categoryList!),
          builder: (context, snapshot) {
            ...
            final columnMentalResourcesRecord = snapshot.data!;
                                                          ...
                                                          if (selectedMedia !=
                                                              ...
                                                              selectedMedia.every((m) =>
                                                                  validateFileFormat(
                                                                      ...
                                                                      context))) {
                                                            safeSetState(() =>
                                                                _model.isDataUploading_newCategory =
                                                                    true);
                                                            ...
                                                            if (selectedUploadedFiles
                                                                ...
                                                                downloadUrls
                                                                    ...
                                                                    selectedMedia
                                                                        .length) {
                                                              safeSetState(() {
                                                                _model.uploadedLocalFile_newCategory =
                                                                    selectedUploadedFiles
                                                                        .first;
                                                                _model.uploadedFileUrl_newCategory =
                                                                    downloadUrls
                                                                        .first;
                                                              });
                                                              showUploadMessage(
                                    ...
                                    Padding(
                                      ...
                                      child: TextFormField(
                                        controller:
                                          ...
                                          text: columnMentalResourcesRecord
                                              .mentalTitle,
                                        ),
                                        ...
                                        children: [
                                          Padding(
                                            ...
                                            child: FFButtonWidget(
                                              onPressed: () async {
                                                await columnMentalResourcesRecord
                                                    .reference
                                                    .update(
