...
import 'thank_you_booking_model.dart';
export 'thank_you_booking_model.dart';

class ThankYouBookingWidget extends StatefulWidget {
  const ThankYouBookingWidget({
    super.key,
  ...
  @override
  State<ThankYouBookingWidget> createState() => _ThankYouBookingWidgetState();
}

class _ThankYouBookingWidgetState extends State<ThankYouBookingWidget> {
  late ThankYouBookingModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ThankYouBookingModel());
                                  ...
                                  child: Align(
                                    ...
                                    child: Padding(
                                      padding: EdgeInsetsDirectional.fromSTEB(
                                          24.0, 0.0, 0.0, 0.0),
                                      child: Text(
                                        'Kindly Check the Approved Sessions Table, Thank!',
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                            .override(
                                              font: GoogleFonts.inter(
