...
import 'send_reject_model.dart';
export 'send_reject_model.dart';

class SendRejectWidget extends StatefulWidget {
  const SendRejectWidget({
    super.key,
  ...
  @override
  State<SendRejectWidget> createState() => _SendRejectWidgetState();
}

class _SendRejectWidgetState extends State<SendRejectWidget> {
  late SendRejectModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SendRejectModel());
    ...
    _model.txtSubjectTextController ??= TextEditingController(
        text:
            '${widget!.sessionType}Appointment  Rejected with Councilor ${widget!.councilorEmail}');
    _model.txtSubjectFocusNode ??= FocusNode();

    _model.txtBodyTextController ??= TextEditingController(
        text:
            'Good Day!${widget!.userEmail}, your schedule for this date: ${dateTimeFormat("MMMMEEEEd", widget!.startTime)}, and time:${dateTimeFormat("Hm", widget!.startTime)}was rejected. Kindly wait for the upcoming time. Thank you and Have a nice day!');
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  _model.sent = await SendEmailCall.call(
                                    toEmail: _model.txtEmailTextController.text,
                                    subject:
                                        _model.txtSubjectTextController.text,
                                    content: _model.txtBodyTextController.text,
                                  );
